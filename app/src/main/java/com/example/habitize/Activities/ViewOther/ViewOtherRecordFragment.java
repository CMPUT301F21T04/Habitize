...
public class ViewOtherRecordFragment extends Fragment implements RecordAdapter.recordViewer {
    ...
    public ViewOtherRecordFragment(Habit habit, ArrayList<Habit> habits){
        this.habit = habit;
        this.habits = habits;
    }

    public ViewOtherRecordFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        DatabaseManager.getSearchedRecord(habit.getRecordAddress(),records,recordAdapter);
        return root;
